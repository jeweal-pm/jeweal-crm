...
class EnquiryEmailAutomationService
{
    ...
    private function data(Model $enquiry, string $type, $subscriber): array
    {
        ...
        return array_merge($context, [
            ...
            'sales_owner_name' => optional($enquiry->assignedTo)->name ?: match ($type) {
                'gis', 'gis_fair' => 'GIS Manage Pro Team',
                'gms', 'gms_fair' => 'GMS Stone Team',
            ...
            'message' => $enquiry->description ?? $enquiry->message ?? $enquiry->remark ?? $enquiry->inquiry,
