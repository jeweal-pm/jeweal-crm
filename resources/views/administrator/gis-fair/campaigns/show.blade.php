...
<section class="funnel-page">
        ...
        @forelse($campaign->trackingLinks as $link)
            <form class="funnel-link-entry" method="post" action="{{ route('gis-fair.links.update', [$campaign, $link]) }}">
                ...
                <div class="funnel-link-fields">
                    ...
                    <div><label>Fair code prefix</label><input class="form-control" name="fair_code_prefix" value="{{ $link->fair_code_prefix }}" placeholder="{{ $campaign->code }}"><div class="funnel-help">Blank uses the event code: {{ $campaign->code }}.</div></div>
    ...
    <form class="funnel-panel" method="post" action="{{ route('gis-fair.links.store', $campaign) }}">
        ...
        <div class="funnel-panel-body funnel-form-grid">
            ...
            <div><label for="link-fair-code-prefix">Fair code prefix</label><input id="link-fair-code-prefix" class="form-control" name="fair_code_prefix" value="{{ old('fair_code_prefix') }}" placeholder="{{ $campaign->code }}"><div class="funnel-help">Blank uses the event code: {{ $campaign->code }}.</div></div>
